...
const Hero = () => {
  return (
    <div className="flex lg:pl-[102px] lg:pt-[267px] md:pl-[53px] md:pt-[184px] pt-[431px] pl-[20px] pr-[12px]">
      <div className="flex flex-col">
        <div className=" flex flex-col bg-text bg-no-repeat bg-left-bottom bg-origin-padding  md:pl-[13.79px] md:pb-[9px]">
