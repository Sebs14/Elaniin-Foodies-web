  ...
  return (
    <div className=' lg:flex pt-10 '>
      <div className='lg:w-3/4'>
        <Titles ids="targetD" titleText={"Estamos para ti"} classes="font-drukTextWide font-bold md:text-5xl text-3xl md:w-full pl-4 w-1/2 pt-6" />
        <div className='flex pt-10'>
          ...
          <button className='flex justify-center items-center w-1/2 text-black border border-gray-300 py-4 ' onClick={changeColor} style={{background:`${colorn}`, color:`${colorTextn}`}} >
            <TbTruckDelivery size={"30px"}/>
            <h3 className=' text-center font-syne font-bold text-lg pl-2'> Domicilio </h3>
          </button>
        </div>
        <form>
          <label htmlFor="default-search" className='mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white'>Search restaurant</label>
          <div className='relative'>
            ...
            } } type="search" id="default-search" className="default-search block w-full p-4 pl-10 text-sm font-noto text-black border border-gray-300  bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Buscar nombre o dirección..." required />
          </div>
        </form>
