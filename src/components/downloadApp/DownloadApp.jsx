  ...
  return (
    <div className='h-screen lg:h-[80vh] bg-white'>
        <div className='lg:flex lg:justify-start lg:flex-row  lg:-space-x-96  flex flex-col justify-center lg:-space-y-0 -space-y-44 px-4'>
          <img className='relative lg:-top-32 lg:max-w-5xl -top-40 lg:pl-0 md:pl-32 pl-20' alt='Mockup phone' src={Mockup}/>  
          <div className='flex-col lg:pt-20 '>
            <div className=' bg-text bg-no-repeat bg-bottom bg-origin-padding px-10'>
              <Titles titleText="Obten más beneficios" classes="text  text-3xl font-bold font-drukTextWide text-center "/>
              <Titles titleText="Descarga nuestra App" classes="text  text-3xl font-bold font-drukTextWide text-center pb-4"/>
            </div>
